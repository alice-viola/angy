/**
 * SpecialistConstants — shared constants and types extracted from Orchestrator.ts.
 *
 * These are used by multiple engine modules (HybridPipelineRunner, ClaudeProcess,
 * AngyEngine, ProfileManager, SpawnConcurrencyTest, OrchestratorPool) and are
 * decoupled from the Orchestrator class itself.
 */
