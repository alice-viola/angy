<template>
  <div
    ...
    class="group relative rounded-xl border p-3 card-glow-review transition-colors"
    :class="cardClasses"
  ...
  >
    <!-- Accent stripe -->
    <div class="accent-stripe bg-[var(--accent-peach)]" />
    ...
    <div class="flex items-center gap-1.5 flex-wrap mb-1.5">
      ...
      <span class="bg-orange-500/10 text-orange-400 text-[10px] px-1.5 py-0.5 rounded-full">review</span>
    </div>
    ...
    <div class="flex items-center gap-1 text-[11px] text-txt-muted mb-1.5">
      <svg class="w-3 h-3" viewBox="0 0 16 16" fill="currentColor">
        <path d="M8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6zm0 1C5.2 3 3 5.2 3 8s2.2 5 5 5 5-2.2 5-5-2.2-5-5-5zm0 2a3 3 0 110 6 3 3 0 010-6z"/>
      </svg>
      needs review
    </div>
