<template>
  ...
  >
    <!-- Accent stripe -->
    <div class="accent-stripe bg-[var(--accent-cyan)]" />
    ...
    <div class="flex items-center gap-1.5 flex-wrap mb-1.5">
      ...
      <span v-if="epic.suspendedAt" class="flex items-center gap-0.5 text-[10px] text-amber-400">
        suspended
        <button
...
const cardClasses = computed(() => {
  ...
  return 'border-border-subtle bg-surface cursor-grab active:cursor-grabbing hover:border-cyan-500/20 hover:shadow-md hover:shadow-black/20';
});
